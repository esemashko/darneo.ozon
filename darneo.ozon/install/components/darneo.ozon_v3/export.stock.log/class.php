...
class OzonExportStockLogComponent extends CBitrixComponent
{
    ...
    private function getLog(): array
    {
        ...
        while ($row = $result->fetch()) {
            ...
            $row['ELEMENT_LINK'] = Loc::getMessage('DARNEO_OZON_STOCK_LOG_ELEMENT_LINK', [
    ...
    {
        $result = StockLogTable::getList(['filter' => ['STOCK_ID' => $this->elementId], 'select' => ['ID']]);
        while ($row = $result->fetch()) {
