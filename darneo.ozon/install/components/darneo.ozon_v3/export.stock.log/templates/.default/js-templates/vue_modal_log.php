                    ...
                    <div class='modal-content'>
                        <div class='modal-header'>
                            <h5 class='modal-title'>
                                {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_STOCK_LOG_SETTINGS') }}
                            </h5>
                            <button class='btn-close' type='button' data-bs-dismiss='modal' aria-label='Close'></button>
                        </div>
                        <div class='modal-body'>
                            <label class='form-label'>
                                {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_STOCK_LOG_AUTO_CLEAR') }}
                            </label>
                            ...
                            <div class='col-md-12 mt-2'>
                                <button type='button' class='btn btn-primary btn-xs fs-8' v-on:click='actionSet()'
                                    ...
                                    <span>{{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_STOCK_LOG_SAVE') }}</span>
                        ...
                        <div class='modal-footer'>
                            <button class='btn btn-secondary' type='button' data-bs-dismiss='modal'>
                                {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_STOCK_LOG_BUTTON_CLOSE') }}
                            </button>
                        </div>
                    </div>
                </div>
