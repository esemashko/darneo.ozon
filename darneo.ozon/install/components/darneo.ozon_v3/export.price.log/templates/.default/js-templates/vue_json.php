            ...
            <div class='modal-dialog modal-lg'>
                <div class='modal-content'>
                    ...
                    <div class='modal-body'>
                        <p>{{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRICE_LOG_DATE_CREATE') }}
                            {{ data.DATE_CREATED }}</p>
                        <div id='sendJson'></div>
                        <hr>
                        <p>{{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRICE_LOG_ANSWER') }}</p>
                        <div id='answer'></div>
                    </div>
                    <div class='modal-footer'>
                        <a v-if='data.SYSTEM_LOG_LINK.length'
                           :href='data.SYSTEM_LOG_LINK' class='btn btn-primary' target='_blank'>
                            {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRICE_SYSTEM_LOG') }}
                        </a>
