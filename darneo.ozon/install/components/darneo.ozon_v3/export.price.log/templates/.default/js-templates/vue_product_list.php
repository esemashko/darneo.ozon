    ...
    template: `
        ...
        <table class='table table-row-bordered table-striped table-row-gray-200 align-middle gs-7 gy-4' id='basic-1'>
            ...
            <tr class='fw-bold text-muted bg-light'>
                <th class='min-w-100px'>{{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRICE_LOG_TABLE_HEAD_DATE') }}</th>
                <th class='min-w-100px'>{{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRICE_LOG_TABLE_HEAD_CODE') }}</th>
                <th class='min-w-125px'>{{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRICE_LOG_TABLE_HEAD_ITEM') }}</th>
                <th class='min-w-125px'>{{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRICE_LOG_TABLE_HEAD_PRICE') }}</th>
                <th class='min-w-100px'>{{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRICE_LOG_TABLE_HEAD_LOG') }}</th>
                <th class='min-w-100px'>{{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRICE_LOG_TABLE_HEAD_STATUS') }}</th>
            </tr>
            </thead>
            <tbody>
