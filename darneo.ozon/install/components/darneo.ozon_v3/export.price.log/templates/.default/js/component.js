                ...
                template: `
                    ...
                    <div class='block_disabled' v-show='request.isUpdateList'></div>
                        <div class='card-body'>
                            <div class='d-flex justify-content-between align-items-start flex-wrap mb-2'>
                                <div class='d-flex flex-column my-4 text-muted'>
                                    <div>
                                        <span class='me-1' v-html='loc.DARNEO_OZON_VUE_PRICE_LOG_COUNT_ALL'></span>
                                        <span class='badge badge-light text-muted' v-html='data.COUNT_ALL'></span>
                                    </div>
                                    <div>
                                        <span class='me-1' v-html='loc.DARNEO_OZON_VUE_PRICE_LOG_AUTO_CLEAR'></span>
                        ...
                        <product-modal
                            ...
                            v-bind:title='loc.DARNEO_OZON_VUE_PRICE_LOG_WARNING'
                        />
                    </div>
                `
            })
