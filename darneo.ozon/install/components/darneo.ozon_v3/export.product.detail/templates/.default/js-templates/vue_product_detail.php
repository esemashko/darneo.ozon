                            ...
                            <div class='row'>
                                <div class='col-md-12'>
                                    <h4 class='text-gray-700'>
                                        {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRODUCT_DETAIL_PRICE_TITLE') }}</h4>
                                </div>
                    ...
                    <div class='card mb-6'>
                        <div class='card-body'>
                            <div class='row'>
                                <div class='col-md-12'>
                                    <h4 class='text-gray-700'>
                                        {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRODUCT_DETAIL_IMG_FILE_TITLE') }}</h4>
                                </div>
                                <div class='col-xs-12 col-lg-6 col-xxl-6 mt-5'>
                                    <ozon-field
                    ...
                    <div class='card mb-6'>
                        <div class='card-body'>
                            <div class='row'>
                                <div class='col-md-12'>
                                    <h4 class='text-gray-700'>
                                        {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRODUCT_DETAIL_FILTER_TITLE') }}</h4>
                                </div>
