            ...
            <table class='table table-row-bordered table-striped table-row-gray-200 align-middle gs-7 gy-4'
                ...
                <tr class='fw-bold text-muted bg-light'>
                    <th class='ps-4 min-w-325px rounded-start'>
                        {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_CRON_LIST_TABLE_HEAD_TITLE') }}
                    </th>
                    <th class='w-400px'>
                        {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_CRON_LIST_TABLE_HEAD_DESCRIPTION') }}
                    </th>
                    <th class='min-w-125px'>
                        {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_CRON_LIST_TABLE_HEAD_DATE_START') }}
                    </th>
                    <th class='min-w-125px'>
                        {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_CRON_LIST_TABLE_HEAD_DATE_FINISH') }}
                    </th>
                    <th class='min-w-125px'>{{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_CRON_LIST_TABLE_HEAD_VALUE') }}
                    </th>
                </tr>
                </thead>
                <tbody>
