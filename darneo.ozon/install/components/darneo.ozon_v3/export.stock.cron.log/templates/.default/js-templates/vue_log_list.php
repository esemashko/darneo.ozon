    ...
    template: `
        ...
        <table class='table table-row-bordered table-striped table-row-gray-200 align-middle gs-7 gy-4' id='basic-1'>
            ...
            <tr class='fw-bold text-muted bg-light'>
                <th class='w-50'>{{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_STOCK_CRON_LOG_TABLE_HEAD_DATE_START') }}</th>
                <th class='w-50'>{{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_STOCK_CRON_LOG_TABLE_HEAD_DATE_FINISH') }}</th>
            </tr>
            </thead>
            <tbody>
            <ozon-log-list-item
