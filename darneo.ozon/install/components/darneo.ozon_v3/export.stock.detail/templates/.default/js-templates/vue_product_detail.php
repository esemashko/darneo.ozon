...
BX.BitrixVue.component('ozon-product-detail', {
    ...
    methods: {
        actionUpdateStore: function () {
            if (this.isUpdateStore === false) {
                this.isUpdateStore = true
                this.$emit('actionUpdateStore')
            }
        },
                    ...
                    <div class='card-body'>
                        <div class='row'>
                            ...
                            <div class='col-xs-12 col-lg-6 col-xxl-6 mt-5'>
                                ...
                                <button type='button' class='btn btn-sm fw-bold btn-success mt-2'
                                        v-on:click='actionUpdateStore()' :disabled='isUpdateStore'>
                                    <span v-html='loc.DARNEO_OZON_VUE_STOCK_LIST_UPDATE_STORE'></span>
                                    <i class='fa fa-spin fa-spinner' v-show='isUpdateStore'></i>
                                </button>
                ...
                <div class='card mb-6'>
                    <div class='card-body'>
                        <div class='row'>
                            ...
                            <div class='col-xs-12 col-lg-12 col-xxl-6 mt-5'>
                                <ozon-field
                                    v-bind:field='data.FIELDS.FILTER_ELEMENT_ACTIVE'
                                    v-bind:isOnlyEdit=true
                                    type='boolean'
                                    v-on:actionUpdateField='actionUpdateField'
                                />
