...
$moduleNames = ['iblock', 'catalog', 'sale', 'currency'];
...
if ($keyId) {
    ...
    Import\Table\TreeCategoryTable::setTablePrefix($keyId);
    Import\Table\TreeTypeTable::setTablePrefix($keyId);
    Import\Table\TreeBindCategoryTypeTable::setTablePrefix($keyId);
