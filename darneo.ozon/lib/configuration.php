...
class Configuration
{
    ...
    private array $data = [
        'entitiesDataClasses' => [
            ...
            // IMPORT
            'iTreeType' => self::NAMESPACE_FOR_ENTITIES . '\Import\Table\TreeTypeTable',
            'iTreeCategory' => self::NAMESPACE_FOR_ENTITIES . '\Import\Table\TreeCategoryTable',
            'iTreeBindCategory' => self::NAMESPACE_FOR_ENTITIES . '\Import\Table\TreeBindCategoryTypeTable',
            ...
            'mSettings' => self::NAMESPACE_FOR_ENTITIES . '\Main\Table\SettingsTable',
            'mSettingsCron' => self::NAMESPACE_FOR_ENTITIES . '\Main\Table\SettingsCronTable',
            'mAccess' => self::NAMESPACE_FOR_ENTITIES . '\Main\Table\AccessTable',
            'mApiLog' => self::NAMESPACE_FOR_ENTITIES . '\Main\Table\ApiLogTable',
            // STAT
            'sSale' => self::NAMESPACE_FOR_ENTITIES . '\Analytics\Table\SaleTable'
        ],
    ];
