...
class Stock extends Manager
{
    public function getFields(): array
    {
        return [
            ...
            'FILTER_ELEMENT_ACTIVE' => new Field(
                [
                    'ENTITY_FIELD' => $this->entity->getField('FILTER_ELEMENT_ACTIVE'),
                    'SHOW_VIEW' => new Fields\Views\Show\Boolean(),
                    'IS_EDIT' => true,
                    'SELECT' => [
                    ...
                    'VALUE' => new Fields\Value\Type\Boolean(
                        [
                            'VALUE' => 'FILTER_ELEMENT_ACTIVE',
                        ]
                    ),
                    'HELPER_TEXT' => Loc::getMessage('DARNEO_OZON_FIELD_CONFIG_STOCK_FILTER_ELEMENT_ACTIVE_HELPER_TEXT')
                ]
            ),
        ];
    }
